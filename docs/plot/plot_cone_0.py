...
# plot the projection of the vector v on the convex cone
...
ax.quiver(0, 0, 0, v[0], v[1], v[2], color='k', arrow_length_ratio=0.1, label='v')
...
# plot the projection
ax.quiver(0, 0, 0, v_proj[0], v_proj[1], v_proj[2], color='grey', arrow_length_ratio=0.1, label='v_proj')
